 ...
 */
export default LayerSwitcher = function (opt_options) {
 ...
 */
LayerSwitcher.prototype.setHeader = function (html) {
 ...
 */
LayerSwitcher.prototype.overflow = function (dir) {
    if (this.button) {	// Nothing to show
        ...
        if (hp > h - dh) {	// Bug IE: need to have an height defined
            ...
            switch (dir) {
                case 1:
                    top += 2 * $("li.visible .li-content", this.panel_).height();
                    break;
                case -1:
                    top -= 2 * $("li.visible .li-content", this.panel_).height();
                    break;
 ...
 * @private
 */
LayerSwitcher.prototype.viewChange = function (e) {
    var map = this.map_;
 ...
 */
LayerSwitcher.prototype.drawPanel = function (e) {
 ...
 * @private
 */
LayerSwitcher.prototype.drawPanel_ = function (e) {
 ...
 */
LayerSwitcher.prototype.switchLayerVisibility = function (l, layers) {
 ...
 * @return {boolean}
 */
LayerSwitcher.prototype.testLayerVisibility = function (layer) {
    if (this.map_) {
        var res = this.map_.getView().getResolution();
 ...
 *    @private
 */
LayerSwitcher.prototype.dragOrdering_ = function (e) {
    var drag = e.data;
    switch (e.type) {	// Start ordering
        ...
        // Ordering
        case 'mousemove':
        case 'touchmove': {	// First drag (more than 2 px) => show drag element (ghost)
            var pageY = e.pageY
                || (e.originalEvent.touches && e.originalEvent.touches.length && e.originalEvent.touches[0].pageY)
                || (e.originalEvent.changedTouches && e.originalEvent.changedTouches.length && e.originalEvent.changedTouches[0].pageY);
 ...
 *    @private
 */
LayerSwitcher.prototype.dragOpacity_ = function (e) {
    var drag = e.data;
 ...
 * @api stable
 */
LayerSwitcher.prototype.drawList = function (ul, collection) {
    var self = this;
    var layers = collection.getArray();
 ...
 *    @private
 */
LayerSwitcher.prototype.setprogress_ = function (layer) {
